...
class Fis11GameProblemSeeder extends Seeder
{
    ...
    public function run(Request $request)
    {
        $questions = array(
            ...
            //stage 1 level 2
            'Pada sistem kesetimbangan benda seperti pada gambar di samping, panjang AB = 80 cm, AC = 60 cm, dan berat 18 N. Jika ujung batang digantungkan beban 3 N, maka tegangan pada tali adalah ...',
            //stage 1 level 3
            'Keseimbangan benda tegar adalah kondisi dimana momentum benda tegar sama dengan nol.',
            //stage 1 level 4
            ...
            //stage 1 level 7
            'Jenis-jenis kesetimbangan benda tegar: stabil, netral, labil',
            //stage 1 level 8
            ...
            //stage 1 level 9
            'Titik berat setengah bola pejal adalah y=3/8R',
            //stage 1 level 10
            'Titik berat kerucut pejal adalah y=1/4t',
            //stage 2 level 1
        ...
        for ($i = 0; $i < 70; $i++) {
            ...
            DB::table('fis11_game_problems_logs')->insert([
                ...
                'description' => 'Create problem id = ' . $problem->id,
