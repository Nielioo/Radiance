...
<div id="main-background">
	...
	<div id="action-buttons" class="option-bar text">
		@if ($level == 10)
		<button class="option-bar-button" onclick="window.location = '{{ route('stages.levels.show', ['stage' => $stage, 'level' => $level]) }}'">
			<div class="option-bar">
				<p class="option-bar-text fs-5 me-3 mb-0">
					Next
				</p>
		...
		@else
		<button class="option-bar-button" onclick="window.location = '{{ route('stages.show', ['stage' => $stage]) }}'">
			<div class="option-bar">
				<p class="option-bar-text fs-5 me-3 mb-0">
					Next
				</p>
