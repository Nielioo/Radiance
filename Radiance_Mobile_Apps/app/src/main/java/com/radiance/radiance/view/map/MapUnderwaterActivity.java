...
public class MapUnderwaterActivity extends AppCompatActivity {
    ...
    private LinearLayout underwaterMap_level1_linearLayout, underwaterMap_level2_linearLayout,
            underwaterMap_level3_linearLayout, underwaterMap_level4_linearLayout,
            underwaterMap_level5_linearLayout, underwaterMap_level6_linearLayout,
            underwaterMap_level7_linearLayout, underwaterMap_level8_linearLayout,
            underwaterMap_level9_linearLayout, underwaterMap_level10_linearLayout;
    ...
    private void setListener() {
        ...
        level2_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent levelTwo = new Intent(MapUnderwaterActivity.this, QuestionActivity.class);
        ...
        level3_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent levelThree = new Intent(MapUnderwaterActivity.this, QuestionActivity.class);
        ...
        level5_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent levelFive = new Intent(MapUnderwaterActivity.this, QuestionActivity.class);
        ...
        level7_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent levelSeven = new Intent(MapUnderwaterActivity.this, QuestionActivity.class);
        ...
        level8_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent levelEight = new Intent(MapUnderwaterActivity.this, QuestionActivity.class);
        ...
        level9_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent levelNine = new Intent(MapUnderwaterActivity.this, QuestionActivity.class);
        ...
        level10_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent levelTen = new Intent(MapUnderwaterActivity.this, QuestionActivity.class);
    ...
    private void setStage() {
        ...
        linearLayouts.add(underwaterMap_level1_linearLayout);
        linearLayouts.add(underwaterMap_level2_linearLayout);
        linearLayouts.add(underwaterMap_level3_linearLayout);
        linearLayouts.add(underwaterMap_level4_linearLayout);
        linearLayouts.add(underwaterMap_level5_linearLayout);
        linearLayouts.add(underwaterMap_level6_linearLayout);
        linearLayouts.add(underwaterMap_level7_linearLayout);
        linearLayouts.add(underwaterMap_level8_linearLayout);
        linearLayouts.add(underwaterMap_level9_linearLayout);
        linearLayouts.add(underwaterMap_level10_linearLayout);
        ...
        storyViewModel.getResultStoryHistoryByStage(String.valueOf(6));
    ...
    private void intView() {
        ...
        underwaterMap_level1_linearLayout = findViewById(R.id.underwaterMap_level1_linearLayout);
        underwaterMap_level2_linearLayout = findViewById(R.id.underwaterMap_level2_linearLayout);
        underwaterMap_level3_linearLayout = findViewById(R.id.underwaterMap_level3_linearLayout);
        underwaterMap_level4_linearLayout = findViewById(R.id.underwaterMap_level4_linearLayout);
        underwaterMap_level5_linearLayout = findViewById(R.id.underwaterMap_level5_linearLayout);
        underwaterMap_level6_linearLayout = findViewById(R.id.underwaterMap_level6_linearLayout);
        underwaterMap_level7_linearLayout = findViewById(R.id.underwaterMap_level7_linearLayout);
        underwaterMap_level8_linearLayout = findViewById(R.id.underwaterMap_level8_linearLayout);
        underwaterMap_level9_linearLayout = findViewById(R.id.underwaterMap_level9_linearLayout);
        underwaterMap_level10_linearLayout = findViewById(R.id.underwaterMap_level10_linearLayout);
